...
export default function ComingSoonPage() {
  ...
  const comingSoonMovies = useMemo(() => {
    let filtered = movies.filter((movie) => movie.type === "coming-soon")
      ...
      <div className="space-y-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-lg">
            Movies you're excited to watch ({comingSoonMovies.length} movies)
          </p>
        </div>
          ...
          <Card className="text-center py-12">
            <CardContent>
              <div className="text-gray-500 dark:text-gray-400">
                <h3 className="text-xl font-semibold mb-2">No upcoming movies!</h3>
                <p>Add movies you're planning to watch to keep track of release dates.</p>
              </div>
            </CardContent>
          </Card>
        ) : (
